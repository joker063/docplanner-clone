    ...
    <div style={{ background: "#00ccb1" }}>
        ...
        <div>
            <select className="style-select">
                ...
                <option value="audi">Czech</option>
            ...
            <img src="https://www.docplanner.com/img/screen-marketplace@2x.png" alt="" class="image1" />
        </div>

    </div>
    <div style={{ background: '#3d83df' }}>
        <h2>For doctors</h2>
        <h1>
...
<section class="global">
    ...
    <div>
        <ul class="global-company-list">
            <li><svg xmlns="http://www.w3.org/2000/svg" width="200" height="32" viewBox="0 0 200 32">
            ...
            <li><svg xmlns="http://www.w3.org/2000/svg" width="167" height="32" viewBox="0 0 167 32">
            ...
            <li><svg xmlns="http://www.w3.org/2000/svg" width="182" height="32" viewBox="0 0 182 32">
            ...
            <li><svg xmlns="http://www.w3.org/2000/svg" width="220" height="32" viewBox="0 0 220 32">
            ...
            <li><svg xmlns="http://www.w3.org/2000/svg" width="195" height="32" viewBox="0 0 195 32">
...
<section class="a">
    <div class="b">
        <p clasNames="world">The world's<br /> biggest healthcare platform</p>
        We work from 6 offices all over the world, bringing Docplanner Group to life in almost 20 countries.
<br /><img className="logo" src="https://www.docplanner.com/img/logo.png" />
    </div>
    <div className="c">
        <div className="d" style={{ marginTop: "30px" }}>
            <img src="https://www.docplanner.com/img/flag.png" /><br />
            <h3>Leader in 10 countries</h3>
            Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile
</div>
        <div className="d">
            <img src="https://www.docplanner.com/img/patients.png" /><br />
            <h3>30 million unique patients</h3>
            visit us every month
</div></div>
        <div class="c">
            <div className="d">
                <img src="https://www.docplanner.com/img/visits.png" /><br />
                <h3>1.5 million appointments</h3>
                booked last month
</div>
            <div className="d">
                <img src="https://www.docplanner.com/img/doctors.png" /><br />
                <h3>2 million active doctors</h3>
                trust in our solutions
</div>
        </div>
</section>
    <p class="improve">Improve the lives of millions.<br /> Change yours forever</p>
    <p class="para">
        More than 1000 team mates share our same vision, goals and<br />
        passion. With offices in Warsaw, Barcelona, Istanbul, Rome,<br />
        Mexico City and Curitiba, our search for great talent never stops.
</p>
    <section className="countries">
        <div className="countries-block">
            <div className="box">
                <img className="img-countries" src="https://www.docplanner.com/images/warsaw.png" /><br />
                <spam className="text-countries">Warsaw</spam>
                <input type="button" className="button" value="SEE OPENINGS" />            </div>
            <div className="box">
                <img src="https://www.docplanner.com/images/barcelona.png" class="img-countries" /><br />
                <spam className="text-countries">Barcelona</spam>
                <input type="button" className="button" value="SEE OPENINGS" />
            </div>
            <div className="box">
                <img src="https://www.docplanner.com/images/istanbul.png" class="img-countries" /><br />
                <spam className="text-countries">Istanbul</spam>
                <input type="button" className="button" value="SEE OPENINGS" />
            </div>
            <div className="box">
                <img src="https://www.docplanner.com/images/rome.png" class="img-countries" /><br />
                <spam className="text-countries">Rome</spam>
                <input type="button" className="button" value="SEE OPENINGS" />
            </div>
            <div clasNames="box">
                <img src="https://www.docplanner.com/images/mexico-city.png" class="img-countries" /><br />
                <spam className="text-countries">Mexico City</spam>
                <input type="button" className="button" value="SEE OPENINGS" />
            </div>
            <div className="box">
                <img src="https://www.docplanner.com/images/curitiba.png" className="img-countries" /><br />
                <spam className="text-countries">Curitiba</spam>
                <input type="button" className="button" value="SEE OPENINGS" />
            </div>
        </div>
    </section>
